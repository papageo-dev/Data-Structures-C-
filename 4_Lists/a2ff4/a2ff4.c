...
void DeleteLastElement(ListPointer *List, ListPointer PredPtr);
...
int main(){
    ...
    /*DIAGRAFH TOY TELEYTAIOU STOIXEIOU THS LISTAS*/
    DeleteLastElement(&AList, PredPtr);

    /*EMFANISH TWN STOIXEIWN THS LISTAS*/
    printf("\n\nTELIKH LISTA, META THN KLHSH THS 'DeleteLastElement()': \n");
    LinkedTraverse(AList);
...
/*SYNARTHSH: DIAGRAFH TOY TELEYTAIOU STOIXEIOU MIAS LISTAS.*/
void DeleteLastElement(ListPointer *List, ListPointer PredPtr)
{
